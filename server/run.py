...
def start_server():
    ...
    print(f"Paths at server start: Main={config.main_directory_path}, Manager={config.manager_exe_path}, Launcher={config.silkroad_launcher_path}")
...
if __name__ == '__main__':
    ...
    print("Paths at server start:", config.main_directory_path, config.manager_exe_path, config.silkroad_launcher_path)
